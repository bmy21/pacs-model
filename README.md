...
The code here (other than [rebin.py](rebin.py), which is taken from the [SciPy Cookbook](https://scipy-cookbook.readthedocs.io/items/Rebinning.html)) was written by [Ben Yelverton](https://github.com/bmy21). Please let me know if you find any issues. If you've found it helpful for any work you're planning to publish, I'd appreciate an acknowledgement. I am grateful to [Grant Kennedy](https://github.com/drgmk) for advice on this work.
